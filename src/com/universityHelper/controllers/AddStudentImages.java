 ...
 */
@WebServlet("/AddStudentImages")
public class AddStudentImages extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddStudentImages() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/AddStudentImages.jsp");
			...
			while (itr.hasNext()) {
				...
				if (item.isFormField()) {
					...
					try {
						...
						String absoluteFilePath = context.getRealPath("/resources/uploads/student/" + folder+"/profile");
