 ...
 */
@WebServlet("/AddStudentCover")
public class AddStudentCover extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddStudentCover() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/AddStudentCover.jsp");
			...
			while (itr.hasNext()) {
				...
				if (item.isFormField()) {
					...
					try {
						...
						String absoluteFilePath = context.getRealPath("/resources/uploads/student/" + folder+"/cover");
