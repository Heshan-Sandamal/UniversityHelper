 ...
 */
@WebServlet("/AddLandLordCover")
public class AddLandLordCover extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddLandLordCover() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/AddLandLordCover.jsp");
			...
			while (itr.hasNext()) {
				...
				if (item.isFormField()) {
					...
					try {
						...
						String absoluteFilePath = context.getRealPath("/resources/uploads/landLord/" + folder+"/cover");
