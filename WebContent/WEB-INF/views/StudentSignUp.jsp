...
<body style="background:url('resources/images/signUp.jpg') no-repeat center center fixed;">
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Student sign up for University Helper <small>It's free!</small></h3>
			 			</div>
			    		...
			    		<form role="form" action="StudentSignUp" method="post">
                            ...
                            <div class="form-group">
			    				<input type="number" name="examYear" id="email" class="form-control input-sm" placeholder="A/L exam year">
			    			</div>
