...
<title>Add Apartment Owner profile pic</title>
</head>
			...
			<div
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="AddLandLordImage" method="post" enctype="multipart/form-data">

							<div class="form-group">
								<input type="text" name="studentId" id="id"
									class="form-control input-sm" placeholder="ID" value="<%= request.getAttribute("ApartmentOwnerId") %>" readonly="readonly">
							</div>
