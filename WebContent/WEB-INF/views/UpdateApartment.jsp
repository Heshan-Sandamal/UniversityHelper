			...
			<div class="col-xs-12 col-sm-8 col-md-9">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="UpdateApartment" method="post">
						<input type="hidden" name="apartmentKey" value="<%=apartment.getApartmentKey()%>">
							...
							<div class="form-group">
								<input type="text" name="address" id="address"
									class="form-control input-sm" placeholder="Address" value="<%=apartment.getAddress()%>">
							</div>

							<div class="form-group">
								<div class="radio">
									
								<% if(apartment.getStudentSex().equals("Boys")){%>
								...
								<label><input type="radio" name="studentSex" value="Boys" >Boys</label>
									<label><input type="radio" name="studentSex" value="Girls" checked="checked">Girls</label>
								<%}%>
								</div>
							</div>
							...
							<div>
								<ul class="list-group" name="universityList" id="universityList">
									 <%for(University university:apartment.getUniversity()){%>
									 	<li class="list-group-item"><%=university.getName()%><input type='hidden' name='univesities' value="<%=university.getName()%>"/></li> 	
									 <%}%>
								</ul>
							</div>
